...
DROP DATABASE IF EXISTS `tocabolas`;
...
CREATE TABLE IF NOT EXISTS `inventario` (
  ...
  KEY `ID user` (`ID_user`) USING BTREE,
  KEY `ID objeto` (`ID_item`) USING BTREE,
  CONSTRAINT `FK_inventario_items` FOREIGN KEY (`ID_item`) REFERENCES `items` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_inventario_users` FOREIGN KEY (`ID_user`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;

-- Volcando datos para la tabla tocabolas.inventario: ~3 rows (aproximadamente)
INSERT INTO `inventario` (`ID_user`, `ID_item`, `Cantidad`) VALUES
	(1, 1, 12),
	(1, 2, 3),
	(1, 3, 5);
...
INSERT INTO `items` (`id`, `nombre`, `descripcion`, `url_icon`, `precio`) VALUES
	(1, 'Bomba', 'Objeto para explotar cualquier bola a tu alrededor!', 'http://dsa2.upc.edu/imagenes/bomba.jpg', 300),
...
INSERT INTO `users` (`id`, `usuario`, `correo`, `password`, `score`, `money`) VALUES
	(1, 'Jan', 'jan@gmail.com', '123', 0, 938799),
	(2, 'Omar', 'omar@gmail.com', '1234', 0, 80000),
	(3, 'Laura', 'laura@gmail.com', '123', 0, 0),
	(4, 'Victor', 'victor@gmail.com', '1234', 0, 0);
